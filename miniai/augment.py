...
# %% ../nbs/14_augment.ipynb 24
class CapturePreds(Callback):
    def before_fit(self): self.all_preds,self.all_targs = [],[]
    def after_batch(self):
        self.all_preds.append(to_cpu(self.learn.preds))
        self.all_targs.append(to_cpu(self.learn.batch[1]))
