...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'miniai.accel': { 'miniai.accel.AccelerateCB': ('ddpm_v2.html#acceleratecb', 'miniai/accel.py'),
            ...
            'miniai.fid': { 'miniai.fid.FID': ('fid.html#fid', 'miniai/fid.py'),
                            'miniai.fid.FID.__call__': ('fid.html#fid.__call__', 'miniai/fid.py'),
                            'miniai.fid.FID.__init__': ('fid.html#fid.__init__', 'miniai/fid.py'),
                            'miniai.fid.FID.from_feats': ('fid.html#fid.from_feats', 'miniai/fid.py'),
                            'miniai.fid.FID.get_feats': ('fid.html#fid.get_feats', 'miniai/fid.py'),
